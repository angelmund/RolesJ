...
class TorneosController extends Controller
{
    ...
    public function crear()
    {
        ...
        return view('torneos.create', compact('modalidades', 'categorias'));
    }
    ...
    public function guardar(Request $request)
    {
        ...
        try {
            ...
            $modalidad->categoria_id = $request->categoria_id;
            $modalidad->save();
    ...
    public function editar($id)
    {
        ...
        $modalidades = Modalidad::all();
        $categorias = Categoria::all();
        return view('torneos.edit', compact('torneo', 'modalidades', 'categorias'));
    }
