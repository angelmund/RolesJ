<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <form id="form" action="{{ route('TorneosGuardar') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label for="categoria_id" class="block text-sm font-medium text-gray-700">Selecciona una
            ...
            <div>
                <label for="modalidad_id" class="block text-sm font-medium text-gray-700">Selecciona la modalidad del
                    torneo</label>
            ...
            <div>
                ...
                <input type="date" id="fecha_inicio" name="fecha_inicio"
                    placeholder="Ingresa la fecha de inicio del torneo"
                    class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
