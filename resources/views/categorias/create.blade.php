<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <form id="form" action="{{ route('CategoriasGuardar') }}" method="POST" class="space-y-4">
            @csrf
            <!-- Nombre -->
            <div>
                <label for="nombre" class="block text-sm font-medium text-gray-700">Nombre</label>
                <input type="text" id="nombre"id="nombre" name="nombre" placeholder="Ingresa el nombre de la Categoría"
            ...
            <div class="text-center">
                ...
                <x-button-link href="{{ route('CategoriasIndex') }}"
                    >
